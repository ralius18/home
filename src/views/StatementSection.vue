  ...
  <v-container>
    <v-card>
      <v-card-text>
        ...
        I have been involved with music since I was young and have lately started exploring the world of audio engineering.
        Recently I have had the opportunity to be mixing live gigs for small, local venues and learning a lot from those around me. -->
      </v-card-text>
    </v-card>
  </v-container>
</template>
